...
function form($instance) {
        ...
        <p><label for="<?php echo $this->get_field_id('username'); ?>"><?php _e('Username:', 'shaken'); ?></label>
        ...
        <p><label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of tweets to show (default = 5):', 'shaken'); ?></label>
...
function widget($args, $instance) {
        ...
        <div class="widget widget_twitter">
            ...
            <a href="http://twitter.com/<?php echo $username; ?>"><img src="<?php echo get_template_directory_uri()."/images/twitter-ic-16.png"; ?>" height="16" width="16" alt=""/></a>&nbsp;
