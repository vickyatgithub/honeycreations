...
function form($instance) {
		...
		<p><label for="<?php echo $this->get_field_id('id'); ?>"><?php _e('Flickr ID (<a href="http://www.idgettr.com/">idGettr</a>):', 'shaken'); ?></label>
        <input class="widefat" id="<?php echo $this->get_field_id('id'); ?>" name="<?php echo $this->get_field_name('id'); ?>" type="text" value="<?php echo $id; ?>" /></p>
        <p><label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of photos to show:', 'shaken'); ?></label>
...
function widget($args, $instance) {
        ...
        <?php if(get_option('shaken_flickr')){ ?> <a href="http://flickr.com/photos/<?php echo get_option('shaken_flickr'); ?>" title="Photos"><img src="<?php echo get_template_directory_uri()."/images/flickr-ic-16.png"; ?>" height="16" width="16" alt=""/></a><?php } else { ?><img src="<?php echo get_template_directory_uri()."/images/flickr-ic-16.png"; ?>" height="16" width="16" alt=""/><?php } ?>&nbsp;
