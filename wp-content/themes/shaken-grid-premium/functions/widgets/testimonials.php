<?php class testimonialWidget extends WP_Widget {
   ...
   function form($instance) {        
       ...
       ?>
       <p>
	   	   <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'shaken'); ?></label>
	       <input type="text" name="<?php echo $this->get_field_name('title'); ?>"  value="<?php echo $title; ?>" class="widefat" id="<?php echo $this->get_field_id('title'); ?>" />
       </p>
       <p>
	   	   <label for="<?php echo $this->get_field_id('text'); ?>"><?php _e('Text:', 'shaken'); ?></label>
			<textarea name="<?php echo $this->get_field_name('text'); ?>" class="widefat" id="<?php echo $this->get_field_id('text'); ?>"><?php echo $text; ?></textarea>
       </p>
       <p>
	   	   <label for="<?php echo $this->get_field_id('citation'); ?>"><?php _e('Citation:', 'shaken'); ?></label>
